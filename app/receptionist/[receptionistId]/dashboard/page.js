        ...
        <section className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
          ...
          <div className="lg:col-span-7 space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="bg-white/80 dark:bg-[#0d1117]/70 backdrop-blur p-5 rounded-2xl border border-black/5 dark:border-white/10 flex items-center gap-4 shadow-sm">
                <div className="w-12 h-12 rounded-xl bg-orange-100 dark:bg-white flex items-center justify-center text-orange-600 dark:text-black">
                  <svg
                    className="w-8 h-8"
                    fill="none"
                    stroke="currentColor"
                  ...
                  >
                    <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4">
                      ...
                      <div className="flex items-center justify-end gap-2 sm:w-52">
                        ...
                        <AppointmentButton text="Scheduled" />
                        <AppointmentButton text="Waiting" />
                      </div>
                    </div>
                  </li>
                ))}
