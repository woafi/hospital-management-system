    ...
    return (
        <div className="w-20 lg:w-64 border-r border-gray-200 dark:border-gray-800 bg-foreground flex flex-col shrink-0 ">
            <nav className="flex-1 p-4 space-y-2 overflow-y-auto">
                <Link href="/doctor/32HDJ3G5/dashboard" className={`flex items-center gap-3 p-3 rounded-lg ${pathname.includes("/dashboard") ? `bg-blue-600/10 text-blue-600` : `text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800`}  transition-colors`}>
                    <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                    </svg>
                    <span className="font-medium hidden lg:block">Dashboard</span>
                </Link>
                <Link href="/doctor/32HDJ3G5/patients" className={`flex items-center gap-3 p-3 rounded-lg ${pathname.includes("/patients") ? `bg-blue-600/10 text-blue-600` : `text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800`}  transition-colors`}>
                    <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
